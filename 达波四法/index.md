...
<h1 class="cat-h1">达波四法</h1>
<p class="cat-lead">冈波巴大师四法 · 三士道次第</p>
...
.cat-card { display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; gap: 8px; min-height: 104px; padding: 22px 18px; border: 1px solid var(--vp-c-divider); border-radius: 12px; background: var(--vp-c-bg-soft); text-decoration: none; transition: border-color .2s ease, transform .2s ease, background .2s ease; }
.cat-card:hover { border-color: #b06a43; background: var(--vp-c-bg); transform: translateY(-2px); }
